...
from util.databases.vote import VoteManage
from util.extras import convert_size
from util.constants import Emojis, Tokens, Client
...
class About(commands.Cog, name="Info about the Bot", description="About this bot."):
    ...
    async def about(self, ctx):
        ...
        embed.add_field(name='Bot Version:', value=self.bot.bot_version, inline=False)
        ...
        embed.add_field(name="RAM Count:", value=convert_size.convert_size(psutil.virtual_memory().total), inline=False)
        ...
        embed.add_field(name='Source Code:', value=f"[Click Here]({Client.github_bot_repo})", inline=False)
