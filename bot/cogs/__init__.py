from cogs import About, Activity, Channels, Calculator, Cogs, Config, Docs, Eval, Fun, Games, Help, InviteTracker, Music, Ping, Slash, SubCommands, Suggestion, Utility
