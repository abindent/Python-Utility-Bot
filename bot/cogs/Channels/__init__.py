...
class Channels(commands.Cog, description='Do some stuffs with the channels.'):
    ...
    @commands.group(invoke_without_command=True, name="new", description="Creates new categories and channels",)
    @commands.guild_only()
