...
class Activities(commands.Cog, name="Discord Activities", description="Create discord activities."):
    ...
    @activity.command(name="Skecth_Heads", description="Creates `Skecth Heads crew` activity in your channel.")
